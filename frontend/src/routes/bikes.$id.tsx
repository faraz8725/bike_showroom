...
export const Route = createFileRoute("/bikes/$id")({
  ...
  notFoundComponent: () => <div className="p-8 text-center">Bike not found.</div>,
});
        ...
        <div className="grid gap-8 lg:grid-cols-[1.3fr_1fr]">
          ...
          <div className="flex flex-col gap-6">
            <div>
              ...
              <p className="mt-4 text-4xl font-bold text-gradient-flame">
                {formatPrice(Number(bike.price))}
              </p>
            </div>
